...
// Layout base js
window.KTApp = require('@/src/js/layout/metronic/demo1/app.js');
window.KTAppLayoutBuilder = require('@/src/js/layout/metronic/demo1/builder.js');
window.KTLayoutSearch = require('@/src/js/layout/metronic/demo1/search.js');
window.KTThemeMode = require('@/src/js/layout/metronic/demo1/theme-mode.js');
